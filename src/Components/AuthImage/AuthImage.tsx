...
const AuthImage = () => {
  return (
    <div className="flex-1 relative flex justify-center items-center">
      <img src={img} className="h-[100vh] w-[100%] object-cover object-left" />
      <div className="absolute mx-[3%] sm:mx-[8%] sm:w-[460px] sm:h-[380px] border-[#7f989a81] border-[2px] rounded-[6px] bg-[#a9c2c642] text-white flex flex-col justify-center">
